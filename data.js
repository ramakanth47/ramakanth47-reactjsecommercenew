...
export const customer = [
  {
    id: 1,
    desc: ""with 30+ years experience in corporate/agency business environments and large conference backstage A/V crew operations. Extensive experience working directly with the C level executives of Fortune 500 companies, corporate executive assistants, agency producers, creative directors, graphic design teams and small business owners.",",
    name: "Bindusri",
    post: "Chief Executive Officer (CEO)",
  },
  {
    id: 2,
    desc: "We firmly believe in Customer's Centricity strategy which aligns a company's development and delivery of its products and services with the current and future ...",
    name: "murdula",
    post: "Managing Director (MD)",
  },
  {
    id: 3,
    desc: "Experience working with various marketing tools, relating to market research, data analytics, website development, product branding ",
    name: "sunitha",
